...
public class PlayerResource {
    ...
    @RequestMapping(value = "/players/nombre/{nombre}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)

    @Timed
    public List<Player> getNamePlayer(@PathVariable String nombre) {
        log.debug("REST request to delete Player : {}", nombre);
        List<Player> players = playerRepository.findByNameLike(nombre);
        return players;
    }
    @RequestMapping(value = "/players/baskets/{baskets}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)

    @Timed
    public List<Player> getBasketsPlayer(@PathVariable int baskets) {
        log.debug("REST request to delete Player : {}", baskets);
        List<Player> players = playerRepository.findByBasketsGreaterThanEqual(baskets);
        return players;
    }
}
